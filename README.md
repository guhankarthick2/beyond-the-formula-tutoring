...
| `VITE_VOLUNTEER_INTRO_VIDEO_URL` | Mentor intro video URL (YouTube **embed** or OneDrive share/embed). Must also be set as a GitHub Actions secret/variable — `.env` only affects local. |
