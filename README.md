...
| `VITE_VOLUNTEER_INTRO_VIDEO_URL` | Mentor intro YouTube **embed** URL (e.g. `https://www.youtube.com/embed/VIDEO_ID`). Must also be set as a GitHub Actions secret/variable — `.env` only affects local. |
